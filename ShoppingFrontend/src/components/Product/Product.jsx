...
const Product = () => {
  ...
  const [isAddingToCart, setIsAddingToCart] = useState(false); // Loading state for addToCart
  ...
  const handleQuantityChange = (e) =>
    setQuantity(Math.max(1, Math.min(product?.stockQuantity, parseInt(e.target.value, 10))));
