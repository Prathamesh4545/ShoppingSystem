...
public class AdminDashboardService {
    ...
    public Map<String, Object> getStats() {
        try {
            ...
            // Get cancelled orders revenue for reference
            Double cancelledRevenue = orderRepo.calculateCancelledRevenue();
            if (cancelledRevenue == null) cancelledRevenue = 0.0;
            ...
            stats.put("cancelledRevenue", cancelledRevenue);
            stats.put("grossRevenue", totalRevenue + cancelledRevenue);
